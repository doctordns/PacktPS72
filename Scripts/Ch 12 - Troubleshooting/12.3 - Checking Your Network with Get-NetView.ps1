...
$FolderHName = 'C:\NetViewOutput'
New-Item -Path $FolderHName -ItemType Directory | Out-Null

# 6. Running Get-View
Get-NetView -OutputDirectory $FolderHName

# 7. Viewing the output folder using Get-ChildItem
$OutputDetails = Get-ChildItem -Path $OF
$OutputDetails
